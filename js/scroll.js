// scrollspy.. taken from https://medium.com/p1xts-blog/scrollspy-with-just-javascript-3131c114abdc
document.addEventListener('DOMContentLoaded', function(){ 
    ...
    const makeActive = (link) => menu_links[link].classList.add("is-active");
    const removeActive = (link) => menu_links[link].classList.remove("is-active");
